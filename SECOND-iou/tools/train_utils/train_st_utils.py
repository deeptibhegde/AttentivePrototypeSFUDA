...
def train_one_epoch_st(model, optimizer, source_reader, target_loader, model_func, prototype, lr_scheduler,
    ...
    for cur_it in range(total_it_each_epoch):
        ...
        st_loss, st_tb_dict, st_disp_dict , prototype = model_func(model, target_batch,prototype)
        st_loss.backward()
...
def train_model_st(model, optimizer, source_loader, target_loader, model_func, prototype,lr_scheduler, optim_cfg,
    ...
    with tqdm.trange(start_epoch, total_epochs, desc='epochs', dynamic_ncols=True,
        ...
        for cur_epoch in tbar:
            ...
            accumulated_iter,prototype = train_one_epoch_st(
                model, optimizer, source_reader, target_loader, model_func,prototype,
