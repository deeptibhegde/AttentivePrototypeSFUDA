...
def eval_single_ckpt(model, test_loader, args, eval_output_dir, logger, epoch_id, dist_test=False):
    # load checkpoint
    model.load_params_from_file(filename=args.ckpt, logger=logger, to_cpu=dist_test,first_it=True)
    model.cuda()
...
def repeat_eval_ckpt(model, test_loader, args, eval_output_dir, logger, ckpt_dir, dist_test=False):
    ...
    while True:
        ...
        model.load_params_from_file(filename=cur_ckpt, logger=logger,first_it=True, to_cpu=dist_test)
        model.cuda()
