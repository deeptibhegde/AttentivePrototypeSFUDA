...
parser.add_argument('--load_pretrained', action='store_true', default=False, help='whether to load ckpt')
...
if __name__ == "__main__":
    ...
    #     rcnn_model = torch.load(args.pretrained_model)["model_state"]
    
    # rpn_model = {}

    # for key, _ in rcnn_model.items():
    #     if key[0:3] == 'rpn':
    #         rpn_model[key] = rcnn_model[key]


    # if args.load_pretrained:

        # model.load_state_dict(rcnn_model)
    ...
    if args.pretrained_model is not None:
        ...
        train_utils.load_part_ckpt(pure_model, filename=args.pretrained_model, logger=logger, total_keys=total_keys)
