...
parser.add_argument("--ckpt_dir", type=str, default=None, help="specify the checkpoint of rcnn if trained separated")
...
def eval_one_epoch_joint(model, dataloader, epoch_id, result_dir, logger):
    ...
    for data in dataloader:
        ...
        # model inference
        ret_dict,_ = model(input_data,prototype=None)
...
if __name__ == "__main__":
    ...
    if args.eval_mode == 'rpn':
        ...
        ckpt_dir = args.ckpt_dir#os.path.join('../', 'output', 'rcnn', cfg.TAG, 'ckpt')
