    ...
    def __getitem__(self, index):
        ...
        if 'annos' in info:
            ...
            if self.dataset_cfg.get('INFO_WITH_FAKELIDAR', False):
                ...
                gt_boxes_lidar = annos['gt_boxes_lidar'][:,:7]
...
def create_waymo_infos(dataset_cfg, class_names, data_path, save_path,
    ...
    train_filename = save_path / ('waymo_processed_data_v0_5_0_infos_%s.pkl' % train_split)
    val_filename = save_path / ('waymo_processed_data_v0_5_0_infos_%s.pkl' % val_split)
...
if __name__ == '__main__':
    ...
    if args.func == 'create_waymo_infos':
        ...
        ROOT_DIR = Path("/mnt/store/dhegde1/data/AV_datasets/")#(Path(__file__).resolve().parent / '../../../').resolve()
        create_waymo_infos(
